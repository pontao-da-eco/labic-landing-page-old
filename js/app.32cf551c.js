                ...
                const h = [
                        {
                            path: "/",
                            component: () =>
                                Promise.all([r.e(736), r.e(807)]).then(
                                    r.bind(r, 9807)
                                ),
                            children: [
                                {
                                    path: "",
                                    component: () =>
                                        Promise.all([r.e(736), r.e(839)]).then(
                                            r.bind(r, 7839)
                                        ),
                                },
                            ],
                        },
                        {
                            path: "/:catchAll(.*)*",
                            component: () =>
                                Promise.all([r.e(736), r.e(193)]).then(
                                    r.bind(r, 2193)
                                ),
                        },
                    ],
                ...
                async function b(e, t) {
                    const o =
                            "function" === typeof d["default"]
                                ? await (0, d["default"])({})
                                : d["default"],
                        { storeKey: a } = await Promise.resolve().then(
                            r.bind(r, 4584)
                        ),
                        i = "function" === typeof m ? await m({ store: o }) : m;
                    o.$router = i;
                    const s = e(c);
                    return (
                        s.use(n.Z, t),
                        { app: s, store: o, storeKey: a, router: i }
                    );
                }
                var g = r(1419);
                const y = { config: {}, components: { QVideo: g.Z } },
                    w = "/";
                async function P(
                    { app: e, router: t, store: r, storeKey: o },
                    n
                ) {
                    let a = !1;
                    const i = (e) => {
                        ...
                        l = window.location.href.replace(
                            window.location.origin,
                            ""
                        );
                    for (let c = 0; !1 === a && c < n.length; c++)
                        try {
                            await n[c]({
                                app: e,
                                router: t,
                            ...
                            return u && u.url
                                ? void s(u.url)
                                : void console.error("[Quasar] boot error:", u);
                        }
                    !0 !== a && (e.use(t), e.use(r, o), e.mount("#q-app"));
                }
                b(o.ri, y).then((e) =>
                    Promise.all([Promise.resolve().then(r.bind(r, 5474))]).then(
                        (t) => {
                            const r = t
                                .map((e) => e.default)
    ...
    (r.m = e),
            ...
            r.O = (t, o, n, a) => {
                if (!o) {
                    ...
                    for (c = 0; c < e.length; c++) {
                        for (
                            var [o, n, a] = e[c], s = !0, l = 0;
                            l < o.length;
                            l++
                        )
                            (!1 & a || i >= a) &&
                            Object.keys(r.O).every((e) => r.O[e](o[l]))
                                ? o.splice(l--, 1)
                                : ((s = !1), a < i && (i = a));
                        if (s) {
                            e.splice(c--, 1);
        ...
        (() => {
            r.u = (e) =>
                ...
                e +
                "." +
                { 193: "f0af8fd2", 807: "fdd50350", 839: "944ca2f5" }[e] +
                ".js";
        })(),
        (() => {
            r.miniCssF = (e) =>
                ...
                "." +
                { 143: "31d6cfe0", 736: "6695016b", 839: "abf08107" }[e] +
                ".css";
        })(),
        (() => {
            r.g = (function () {
        ...
        (() => {
            ...
            var t = (t, o) => {
                ...
                o = (self["webpackChunkapp"] = self["webpackChunkapp"] || []);
            o.forEach(t.bind(null, 0)), (o.push = t.bind(null, o.push.bind(o)));
        })();
    var o = r.O(void 0, [736], () => r(2318));
    o = r.O(o);
})();
